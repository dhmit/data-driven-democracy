            ...
            {dataToDisplay && dataToDisplay.length > 0 && (
                <div>
                    ...
                    <div>
                        ...
                        <span style={{fontWeight: "normal"}}>
                            {dataToDisplay[0].constituency_name.charAt(0).toUpperCase() +
                                dataToDisplay[0].constituency_name.slice(1).toLowerCase()}
                        </span>
                    </div>
                    <div>
                        <span style={{fontWeight: "bold"}}>Winning Party: &nbsp;</span>
                        <span style={{fontWeight: "normal"}}>{dataToDisplay[0].party_name}</span>
                    </div>
                    <div>
